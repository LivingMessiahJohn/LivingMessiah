...
namespace PWA.Features.ThresholdCovenant;
...
{
	public static string BookSectionCards = "PWA.Features.ThresholdCovenant.BookSections.";
	public static string SubSectionCards = "PWA.Features.ThresholdCovenant.BookSections.SubSections.";
}
