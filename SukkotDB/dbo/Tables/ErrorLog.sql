CREATE TABLE [dbo].[ErrorLog] (
    ...
    [BatchLogJobId]  INT             CONSTRAINT [DF_ErrorLog_JobId] DEFAULT ((0)) NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Audit table tracking errors in the the OsisXmlToSql database that are caught by the CATCH block of a TRY...CATCH construct. Data is inserted by stored procedure dbo.stpLogError when it is executed from inside the CATCH block of a TRY...CATCH construct.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ErrorLog';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'If used, the value comes from BatchLogJob.Id', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ErrorLog', @level2type = N'COLUMN', @level2name = N'BatchLogJobId';
