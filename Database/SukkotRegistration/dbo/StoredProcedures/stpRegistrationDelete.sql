...
CREATE   PROCEDURE [dbo].[stpRegistrationDelete] ( @RegistrationId int)
/*
	DECLARE @RC int
	EXECUTE @RC = dbo.stpRegistrationDelete 1016
...
BEGIN TRY
	...
	SELECT @DonationRowCount =  ISNULL(COUNT(*),0) FROM dbo.Donation WHERE RegistrationId = @RegistrationId;
