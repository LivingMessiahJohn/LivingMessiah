...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'House Rules Agreement is signed so Start Registration', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Constants', @level2type = N'COLUMN', @level2name = N'StatusStartRegistrationId';
