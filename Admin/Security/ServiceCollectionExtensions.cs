...
using Admin.Security.Policies;
using ConfigurationConstants = Admin.Security.Constants.Configuration;
using AuthFailedRedirectConstants = Admin.Security.Constants.AuthFailedRedirect;
using Microsoft.AspNetCore.Authentication.OpenIdConnect;

namespace Admin.SecurityRoot;
