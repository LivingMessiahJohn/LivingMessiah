...
using LivingMessiahAdmin.Features.KeyDates.Constants;
using FeastDayType = LivingMessiahAdmin.Features.KeyDates.Enums.FeastDay;

// Port from C:\Source\repos\LivingMessiah\LivingMessiah\Features\FeastDayPlanner\Enums\FeastDayDetail.cs

namespace LivingMessiahAdmin.Features.KeyDates.Enums;

public abstract class FeastDayDetailFDPVer : SmartEnum<FeastDayDetailFDPVer>
{
	#region Id's
	...
	public static readonly FeastDayDetailFDPVer HanukkahDay1 = new HanukkahDay1SE();
	public static readonly FeastDayDetailFDPVer HanukkahDay8 = new HanukkahDay8SE();

	public static readonly FeastDayDetailFDPVer Purim = new PurimSE();

	public static readonly FeastDayDetailFDPVer UnleavenedBreadDay1 = new UnleavenedBreadDay1SE();
	public static readonly FeastDayDetailFDPVer StartOmer = new StartOmerSE();
	public static readonly FeastDayDetailFDPVer UnleavenedBreadDay7 = new UnleavenedBreadDay7SE();

	public static readonly FeastDayDetailFDPVer StopOmer = new StopOmerSE();
	public static readonly FeastDayDetailFDPVer Weeks = new WeeksSE();

	public static readonly FeastDayDetailFDPVer Trumpets = new TrumpetsSE();
	public static readonly FeastDayDetailFDPVer YomKippur = new YomKippurSE();

	public static readonly FeastDayDetailFDPVer SukkotDay1 = new SukkotDay1SE();
	public static readonly FeastDayDetailFDPVer SukkotDay8 = new SukkotDay8SE();
	public static readonly FeastDayDetailFDPVer SukkotCampTearDown = new SukkotCampTearDownSE();
	// SE=SmartEnum
	#endregion

	private FeastDayDetailFDPVer(string name, int value) : base(name, value) { } // Constructor
	...
	private sealed class HanukkahDay1SE : FeastDayDetailFDPVer
	{
	...
	private sealed class HanukkahDay8SE : FeastDayDetailFDPVer
	{
	...
	private sealed class PurimSE : FeastDayDetailFDPVer
	{
	...
	private sealed class UnleavenedBreadDay1SE : FeastDayDetailFDPVer
	{
	...
	private sealed class StartOmerSE : FeastDayDetailFDPVer
	{
	...
	private sealed class UnleavenedBreadDay7SE : FeastDayDetailFDPVer
	{
	...
	private sealed class StopOmerSE : FeastDayDetailFDPVer
	{
	...
	private sealed class WeeksSE : FeastDayDetailFDPVer
	{
	...
	private sealed class TrumpetsSE : FeastDayDetailFDPVer
	{
	...
	private sealed class YomKippurSE : FeastDayDetailFDPVer
	{
	...
	private sealed class SukkotDay1SE : FeastDayDetailFDPVer
	{
	...
	private sealed class SukkotDay8SE : FeastDayDetailFDPVer
	{
	...
	private sealed class SukkotCampTearDownSE : FeastDayDetailFDPVer
	{
