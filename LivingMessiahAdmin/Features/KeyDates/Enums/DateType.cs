...
public abstract class DateType : SmartEnum<DateType>
{
	...
	private sealed class MonthSE : DateType
	{
		...
		public override string CalendarColor => Constants.CalendarColors.Dark;
	...
	private sealed class FeastSE : DateType
	{
		...
		public override string CalendarColor => Constants.CalendarColors.Blue;
	...
	private sealed class SeasonSE : DateType
	{
		...
		public override string CalendarColor => Constants.CalendarColors.Olive;
