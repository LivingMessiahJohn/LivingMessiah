...
using LivingMessiah.Features.FeastDayPlanner.Constants;
using System;
...
public abstract class FeastDayDetail : SmartEnum<FeastDayDetail>
{
	...
	public static readonly FeastDayDetail HanukkahDay8 = new HanukkahDay8SE();
	...
	private sealed class HanukkahDay8SE : FeastDayDetail
	{
