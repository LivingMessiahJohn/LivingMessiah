...
public class Section
{
	...
	public static Section CallToService { get; } = new Section(
		SectionEnum.CallToService, "shofar-call-to-service-with-time-1024-385.jpeg", "Call to Service", "Toggle01", "3:00 pm");

	public static Section OpeningAdoration { get; } = new Section(
		SectionEnum.OpeningAdoration, "blessed-be-he-who-spoke-1024-385.jpeg", "Opening Adoration", "Toggle02", "3:03 pm");

	public static Section PraiseAndWorship { get; } = new Section(
		SectionEnum.PraiseAndWorship, "praise-and-worship-1024-385.jpeg", "Praise and Worship", "Toggle03", "3:10 pm");

	public static Section CommunityPrayer { get; } = new Section(
		SectionEnum.CommunityPrayer, "community-prayer-1024-385.jpeg", "Community Prayer", "Toggle04", "3:22 pm");

	public static Section ChildrensBlessing { get; } = new Section(
		SectionEnum.ChildrensBlessing, "childrens-blessing-1024-385.jpeg", "Children's Blessing", "Toggle05", "3:34 pm");

	public static Section OsehShalom { get; } = new Section(
		SectionEnum.OsehShalom, "oseh-shalom-1024-385.jpeg", "Oseh Shalom", "Toggle06", "3:36 pm");
	...
	public static Section Announcements { get; } = new Section(
		SectionEnum.Announcements, "announcements-1024-385.jpeg", "Announcements", "Toggle09", " 3:38 pm");

	public static Section EtzChaim { get; } = new Section(
		SectionEnum.EtzChaim, "etz-chaim-1024-385.jpeg", "Etz Chaim", "Toggle10", "4:00 pm");
	...
	public static Section TorahParahsa { get; } = new Section(
		SectionEnum.TorahParahsa, "torah-parahsa-green-1024-385.jpeg", "Torah Parahsa", "Toggle12", "4:02 pm");  //torah-parahsa-purple-1024-385.jpeg

	//public static Section Midrash { get; } = new Section(
	//	SectionEnum.Midrash, "midrash-1024-385.jpeg", "Midrash", "Toggle13", "4:03 pm"); 

	public static Section Avinu { get; } = new Section(
		SectionEnum.Avinu, "avinu-1024-385.jpeg", "Avinu Prayer", "Toggle14", "4:10 pm");

	public static Section AhronicBlessing { get; } = new Section(
		SectionEnum.AhronicBlessing, "ahronic-blessing-1024-385.jpeg", "Aaronic Blessing", "Toggle15", "5:02 pm");
