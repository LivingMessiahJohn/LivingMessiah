...
using FDD = LivingMessiah.Features.FeastDayPlanner.Enums.FeastDayDetail;
...
public abstract class FeastDay : SmartEnum<FeastDay>
{
	...
	private sealed class HanukkahSE : FeastDay
	{
		...
		public override DateRange Range => new (Date, FDD.HanukkahDay8.Date);
	...
	private sealed class PurimSE : FeastDay
	{
		...
		public override DateRange Range => new (Date, FDD.Purim.Date);
	...
	private sealed class PassoverSE : FeastDay
	{
		...
		public override DateRange Range => new (Date, FDD.UnleavenedBreadDay7.Date);
	...
	private sealed class WeeksSE : FeastDay
	{
		...
		public override DateRange Range => new (Date, FDD.Weeks.Date);
	...
	private sealed class TrumpetsSE : FeastDay
	{
		...
		public override DateRange Range => new (Date, FDD.Trumpets.Date);
	...
	private sealed class YomKippurSE : FeastDay
	{
		...
		public override DateRange Range => new (Date, FDD.YomKippur.Date);
	...
	private sealed class TabernaclesSE : FeastDay
	{
		...
		public override DateRange Range => new(Date, FDD.SukkotCampTearDown.Date);
