...
public abstract class LunarMonth : SmartEnum<LunarMonth>
{
  ...
  public DateTime DateTime2 => Date.ToDateTime(new TimeOnly(12, 0)); 
  

  public DateOnly ErevDate => Date == DateOnly.MinValue // Safe DateOnly properties — avoid DateTime underflow when Date == DateTime.MinValue
  ? DateOnly.MinValue
  : Date.AddDays(-1);

  public DateOnly DayTimeDate => Date == DateOnly.MinValue
    ? DateOnly.MinValue
    : Date;

  //text-white
  public MarkupString DayCellErevHtml => (MarkupString)$"<span class='badge bg-info fs-6 text-black float-end'><i class='far fa-moon'></i></span>";
  public MarkupString DayCellDayTimeHtml => (MarkupString)$"<span class='badge bg-info fs-6 text-black'>{FullName}</span>";

  public MarkupString DayCellHtml => (MarkupString)$"<span class='badge bg-info fs-5 text-white'><i class='far fa-moon'></i> {FullName}</span>";
  ...
  public string FullNameCSS
	...
	private sealed class HeshvanPrevGregYrMonth : LunarMonth
	{
		...
		public override DateOnly Date => LunarMonthDates.HeshvanPrevGregYrMonth;
	...
	private sealed class KislevPrevGregYrMonth : LunarMonth
	{
		...
		public override string Description => String.IsNullOrEmpty(BiblicalHebrew) ? $"{BiblicalName}" : $"{BiblicalName} {BiblicalHebrew}";
		public override FullNameCategory MonthDuplicate => FullNameCategory.PreviousYear;
		public override DateOnly Date => LunarMonthDates.KislevPrevGregYrMonth;
	...
	private sealed class TevetPrevGregYrMonth : LunarMonth
	{
		...
		public override string Description => String.IsNullOrEmpty(BiblicalHebrew) ? $"{BiblicalName}" : $"{BiblicalName} {BiblicalHebrew}";
		public override FullNameCategory MonthDuplicate => FullNameCategory.PreviousYear;
		public override DateOnly Date => LunarMonthDates.TevetPrevGregYrMonth;
	...
	private sealed class Adar2Month : LunarMonth
	{
		...
		public override DateOnly Date => LunarMonthDates.Adar2; // if Adar2 == DateTime.MinValue then there is no Adar II in this year
